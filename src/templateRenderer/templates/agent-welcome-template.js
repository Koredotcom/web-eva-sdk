				...
				<div class="chipone" id="awt-${item?.id}-${i}">
					<div class="leftBlock">
						<span class="tickmarkicon">
							<svg width="13" height="13" class="wa-RightArrow " viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.33337 6.00016H10.6667M10.6667 6.00016L6.00004 1.3335M10.6667 6.00016L6.00004 10.6668" stroke="#2970FF" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"></path></svg>
						</span>
